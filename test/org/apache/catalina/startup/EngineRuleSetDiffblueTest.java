...
public class EngineRuleSetDiffblueTest {
  /**
   * Test {@link EngineRuleSet#EngineRuleSet()}.
   * <ul>
   *   <li>Then return {@link EngineRuleSet#prefix} is empty string.</li>
   * </ul>
   * <p>
   * Method under test: {@link EngineRuleSet#EngineRuleSet()}
   */
  @Test
  public void testNewEngineRuleSet_thenReturnPrefixIsEmptyString() {
    // Arrange, Act and Assert
    assertEquals("", (new EngineRuleSet()).prefix);
  }

  /**
   * Test {@link EngineRuleSet#EngineRuleSet(String)}.
   * <ul>
   *   <li>When {@code Prefix}.</li>
   *   <li>Then return {@code Prefix}.</li>
   * </ul>
   * <p>
   * Method under test: {@link EngineRuleSet#EngineRuleSet(String)}
   */
  @Test
  public void testNewEngineRuleSet_whenPrefix_thenReturnPrefix() {
    // Arrange, Act and Assert
    assertEquals("Prefix", (new EngineRuleSet("Prefix")).prefix);
  }

  /**
   * Test {@link EngineRuleSet#addRuleInstances(Digester)}.
   * <ul>
   *   <li>When {@link Digester} (default constructor).</li>
   *   <li>Then {@link Digester} (default constructor) Rules rules size is fifty-two.</li>
   * </ul>
   * <p>
   * Method under test: {@link EngineRuleSet#addRuleInstances(Digester)}
   */
  @Test
  public void testAddRuleInstances_whenDigester_thenDigesterRulesRulesSizeIsFiftyTwo() {
    // Arrange
    EngineRuleSet engineRuleSet = new EngineRuleSet("Prefix");
    Digester digester = new Digester();

    // Act
    engineRuleSet.addRuleInstances(digester);

    // Assert
    Rules rules = digester.getRules();
    List<Rule> rulesResult = rules.rules();
    assertEquals(52, rulesResult.size());
    Rule getResult = rulesResult.get(50);
    ...
    Rule getResult3 = rulesResult.get(51);
